...
namespace SF.Serialization.Protobuf
{
    /// <summary>
    ...
    internal class ProtoSizeCalc : IOutputStream
    {
        ...
        {
            _size += value >= 0 ? GetVarInt32Size((uint) value) : 10;
        }

        public void WriteInt64(long value)
        {
            _size += GetVarInt64Size((ulong) value);
        }

        public void WriteUInt32(uint value)
        {
            _size += GetVarInt32Size(value);
        }

        public void WriteUInt64(ulong value)
        {
            _size += GetVarInt64Size(value);
        }

        public void WriteSInt32(int value)
        {
            _size += GetVarInt32Size(ProtoOutputStream.EncodeZigZag32(value));
        }

        public void WriteSInt64(long value)
        {
            _size += GetVarInt64Size(ProtoOutputStream.EncodeZigZag64(value));
        }
        ...
        void IOutputStream.WriteString(string value)
        {
            if (!string.IsNullOrEmpty(value))
            {
                ...
                _size += GetVarInt32Size((uint) size) + size;
            }
            else
            {
                _size++;
        ...
        void IOutputStream.WriteMessage(IMessage message)
        {
            ...
            _size += GetVarInt32Size((uint) size);
        }
