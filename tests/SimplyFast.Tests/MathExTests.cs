...
namespace SimplyFast.Tests
{
    ...
    public class MathExTests
    {
        ...
        public void ClipIsMethodOfMathHelperAndItReturnsValueIfInRange()
        {
            ...
            Assert.AreEqual(v12, v12.Clip(TimeSpan.FromDays(0), TimeSpan.FromDays(2)));
        ...
        public void ClipReturnsMaxIfValueGreater()
        {
            ...
            Assert.AreEqual(TimeSpan.FromDays(5), v12.Clip(TimeSpan.FromDays(3), TimeSpan.FromDays(5)));
        ...
        public void ClipReturnsMinIfValueLess()
        {
            ...
            Assert.AreEqual(TimeSpan.FromDays(3), v12.Clip(TimeSpan.FromDays(3), TimeSpan.FromDays(5)));
        ...
        public void InRangeWorks()
        {
            ...
            Assert.IsTrue(TimeSpan.FromDays(10).InRange(TimeSpan.FromDays(1), TimeSpan.FromDays(11)));
            Assert.IsTrue(TimeSpan.FromDays(10).InRange(TimeSpan.FromDays(10), TimeSpan.FromDays(11)));
            Assert.IsTrue(TimeSpan.FromDays(10).InRange(TimeSpan.FromDays(9), TimeSpan.FromDays(10)));
